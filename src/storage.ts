...
export type Store = { workouts: WorkoutLog[]; nutrition: DayNutrition[]; measurements: Measurement[]; reminders?: ReminderSettings; activePlan?: ActivePlan; workoutOverrides?:Record<string,ImportedWorkout>; lastBackup?: string }
